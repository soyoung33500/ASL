 ...
 * objects.
 */
public class DetectorActivity<listener> extends CameraActivity implements OnImageAvailableListener {
                    ...
                    public void run() {
                        ...
                        for (final Classifier.Recognition result : results) {
                            ...
                            if (location != null && result.getConfidence() >= minimumConfidence) {
                                ...
                                //txtView.append(result.getTitle());
...
// 유료 회원 코드 였던 것
    public void showText(View v) {
        Toast.makeText(DetectorActivity.this, "수화를 인식시켜 주세요.", Toast.LENGTH_SHORT).show();
    }
